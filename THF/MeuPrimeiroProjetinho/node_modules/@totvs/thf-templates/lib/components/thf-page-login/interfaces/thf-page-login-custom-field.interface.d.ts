 ...
 * @description
 *
 * Interface com a definição do Custom Field, podendo ser utilizado para informar um campo customizado no componente `thf-page-login`.
 */
export interface ThfPageLoginCustomField {
     ...
     * @description
     *
     * Lista de opções de um `thf-select`.
     */
     ...
     * lista de itens do componente `thf-combo`.
     */
    url?: string;
    /**
     * @optional
     ...
     * lista do componente `thf-combo`, esta propriedade será responsável pelo valor de cada item da lista.
     *
     */
    fieldValue?: string;
}
