 ...
 * ```
 */
export declare abstract class ThfPageChangePasswordBaseComponent {
     ...
     */
    recovery: string | Function | ThfPageChangePasswordRecovery;
    /**
     * @optional
     *
     * @description
     ...
     */
    requirements: Array<ThfPageChangePasswordRequirement>;
    /**
     * @optional
     *
     * @description
