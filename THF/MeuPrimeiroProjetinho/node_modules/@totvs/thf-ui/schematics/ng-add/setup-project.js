...
/** THF Module name that will insert in app root module */
const thfModuleName = 'ThfModule';
const thfModuleSourcePath = '@totvs/thf-ui';
/**
 * Scaffolds the basics of a Angular Material application, this includes:
 *  - Add THF Module to app root module
 *  - Adds themes to styles
 *  - Run sidemenu schematic
 */
function default_1(options) {
    return schematics_1.chain([
        module_1.addModuleImportToRootModule(options, thfModuleName, thfModuleSourcePath),
        addThemeToAppStyles(options),
        configureSideMenu(options)
    ]);
}
exports.default = default_1;
/** Add THF theme to project styles */
function addThemeToAppStyles(options) {
    return function (tree) {
        const workspace = config_1.getWorkspace(tree);
        const project = project_1.getProjectFromWorkspace(workspace, options.project);
        // Path needs to be always relative to the `package.json` or workspace root.
        const themePath = './node_modules/@totvs/thf-theme/css/thf-theme-default.min.css';
