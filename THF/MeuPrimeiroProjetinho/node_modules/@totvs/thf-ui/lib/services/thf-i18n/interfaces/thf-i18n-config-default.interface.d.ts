 ...
 * @description
 *
 * <a id="thfI18nConfigDefault"></a>
 *
 * Interface para a configuração padrão do módulo ThfI18nModule.
 *
 * @usedBy ThfI18nModule
 */
export interface ThfI18nConfigDefault {
    /**
     ...
     * [`setLanguage()`](documentation/thf-i18n#setLanguage). Caso nenhum dos dois tenha sido configurado, será utilizado
