 ...
 */
export declare class ThfMask {
    mask: string;
    formatModel: boolean;
    initialPosition: number;
    finalPosition: number;
    pattern: string;
    readonly getPattern: string;
    valueToInput: string;
    readonly getValueToInput: string;
    setValueToInput: string;
    valueToModel: string;
    readonly getValueToModel: string;
    setValueToModel: string;
