...
export declare const thfListViewLiteralsDefault: {
 ...
 */
export declare class ThfListViewBaseComponent {
    private _actions;
    private _height;
    ...
    onClickAction(listViewAction: ThfListViewAction, item: any): void;
    onShowMore(): void;
