import { ThfMenuItemBadge } from './thf-menu-item/thf-menu-item-badge.interface';
/**
...
export interface ThfMenuItem {
     ...
     *
     * > O `thf-badge` só será exibido caso o item do menu não possua `subItems` e seu valor seja maior ou igual a 0.
     */
    badge?: ThfMenuItemBadge;
    ...
    /**
     * Ícone para o item de menu, os [ícones aceitos](/guides/icons) são os definidos no guia de estilo da Totvs.
